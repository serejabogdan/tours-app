  ...
  return (
    <header className="header header--black">
      <div className="header__logo">
        <svg className={isColor(color, 'header__icon', 'header__icon header__icon--black')} viewBox="0 -101 713.75189 713" xmlns="http://www.w3.org/2000/svg">
      ...
      <nav className="header__nav">
        {navLinks.map(({name, href, className}) => (
          <a className={className} href={href} key={name}>
            {name}
          </a>
        ))}
      </nav>
