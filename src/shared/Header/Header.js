  ...
  return (
    <header className="header header--black">
      <div className="header__logo">
        <svg
          className={isColor(color, 'header__icon', 'header__icon header__icon--black')}
          viewBox="0 -101 713.75189 713"
        ...
        <span className={isColor(color, 'header__text', 'header__text header__text--black')}>
          подорож
        </span>
      </div>
